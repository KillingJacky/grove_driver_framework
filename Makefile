...
GCC_BIN = 
PROJECT = mbed_1768_grove_driver_framework

OBJECTS = ./main.o ./grove_drivers/suli2.o ./grove_rpc_server/rpc_server.o ./grove_rpc_server/rpc_server_registration.o ./grove_rpc_server/rpc_stream.o
OBJECTS += ./grove_drivers/Grove_Example/GroveExample.o ./grove_drivers/Grove_Example/GroveExample_Generated.o 
...
INCLUDE_PATHS += -I./grove_drivers -I./grove_rpc_server
INCLUDE_PATHS += -I./grove_drivers/Grove_Example
